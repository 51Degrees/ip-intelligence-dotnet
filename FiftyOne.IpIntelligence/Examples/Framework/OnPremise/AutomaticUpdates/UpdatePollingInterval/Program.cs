...
/// <summary>
/// @example OnPremise/AutomaticUpdates/UpdatePollingInterval/Program.cs
/// 
/// @include{doc} example-automatic-updates-polling-interval-ipi.txt
/// 
...
/// ```
/// </summary>
namespace FiftyOne.IpIntelligence.Examples.OnPremise.AutomaticUpdates.UpdatePollingInterval
{
    public class Program
    {
        public class Example : ExampleBase
        {
            ...
            public void Run(string dataFile, string licenseKey)
            {
                ...
                pipeline = new IpiPipelineBuilder(loggerFactory, httpClient, dataUpdateService)
