...
namespace FiftyOne.IpIntelligence.Engine.OnPremise.Data
{
    ...
    public class ComponentMetaData : IComponentMetaData, IDisposable
    {
            ...
            ComponentMetaDataSwig source)
        {
            _engine = engine;
            _source = source;
            ProfileMetaDataSwig _defaultProfile = _engine.MetaData.getDefaultProfileForComponent(_source);
            // There is no default profile if a component is dynamic
            if (_defaultProfile != null) 
            {
                DefaultProfile = new ProfileMetaData(_engine, _defaultProfile);
            }
        }
        ...
        /// </summary>
        public IProfileMetaData DefaultProfile { get; }
        ...
        public IEnumerable<IFiftyOneAspectPropertyMetaData> GetProperties()
        {
                ...
                _engine.MetaData.getPropertiesForComponent(_source))
            {
                ...
                {
                    yield return new PropertyMetaDataIpi(
                        _engine,
#pragma warning disable CA2000 // Dispose objects before losing scope
                        // The 'PropertyMetaDataIpi' instance uses the property
...
#pragma warning restore CA2000 // Dispose objects before losing scope
                if (property != null)
                {
                    result = new PropertyMetaDataIpi(_engine, property);
                }
            }
            return result;
        }
