...
internal class ComponentMetaDataSwig : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IpIntelligenceEngineModulePINVOKE.delete_ComponentMetaDataSwig(swigCPtr);
        }
  ...
  public int getComponentIdAsInt() {
    int ret = IpIntelligenceEngineModulePINVOKE.ComponentMetaDataSwig_getComponentIdAsInt(swigCPtr);
  ...
  public SWIGTYPE_p_byte getComponentId() {
    SWIGTYPE_p_byte ret = new SWIGTYPE_p_byte(IpIntelligenceEngineModulePINVOKE.ComponentMetaDataSwig_getComponentId(swigCPtr), true);
    if (IpIntelligenceEngineModulePINVOKE.SWIGPendingException.Pending) throw IpIntelligenceEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public string getName() {
    string ret = IpIntelligenceEngineModulePINVOKE.ComponentMetaDataSwig_getName(swigCPtr);
    if (IpIntelligenceEngineModulePINVOKE.SWIGPendingException.Pending) throw IpIntelligenceEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
