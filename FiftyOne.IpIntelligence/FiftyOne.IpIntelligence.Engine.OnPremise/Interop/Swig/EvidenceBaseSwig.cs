...
internal class EvidenceBaseSwig : MapStringStringSwig {
  ...
  internal EvidenceBaseSwig(global::System.IntPtr cPtr, bool cMemoryOwn) : base(IpIntelligenceEngineModulePINVOKE.EvidenceBaseSwig_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  protected override void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IpIntelligenceEngineModulePINVOKE.delete_EvidenceBaseSwig(swigCPtr);
        }
  ...
  public EvidenceBaseSwig() : this(IpIntelligenceEngineModulePINVOKE.new_EvidenceBaseSwig(), true) {
