...
internal class Date : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IpIntelligenceEngineModulePINVOKE.delete_Date(swigCPtr);
        }
  ...
  public int getYear() {
    int ret = IpIntelligenceEngineModulePINVOKE.Date_getYear(swigCPtr);
  ...
  public int getMonth() {
    int ret = IpIntelligenceEngineModulePINVOKE.Date_getMonth(swigCPtr);
    if (IpIntelligenceEngineModulePINVOKE.SWIGPendingException.Pending) throw IpIntelligenceEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int getDay() {
    int ret = IpIntelligenceEngineModulePINVOKE.Date_getDay(swigCPtr);
    if (IpIntelligenceEngineModulePINVOKE.SWIGPendingException.Pending) throw IpIntelligenceEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
