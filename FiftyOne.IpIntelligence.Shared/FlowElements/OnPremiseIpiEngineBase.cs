...
{
    /// <summary>
    /// On-premise IP intelligence engine base class. 
    /// </summary>
    /// <typeparam name="T">
    /// The specific type of IP intelligence data instances returned by this 
    /// engine.
    /// </typeparam>
        ...
        where T : IIpIntelligenceData
    {
        ...
        /// </param>
        public OnPremiseIpiEngineBase(ILogger<FiftyOneOnPremiseAspectEngineBase<T>> logger,
        ...
        /// <summary>
        /// This event is fired after IP intelligence data has been 
        ...
        public override void AddDataFile(IAspectEngineDataFile dataFile)
        {
            ...
            // Data files for OnPremise IP Intelligence engines are not 
