...
namespace FiftyOne.IpIntelligence.Tests.Core
{
    ...
    public class IpIntelligencePipelineBuilderTests
    {
        ...
        /// </param>
        [DataTestMethod]
        [DataRow(TestHelpers.Constants.IPI_DATA_FILE_NAME, true, false, null)]
        [DataRow(TestHelpers.Constants.IPI_DATA_FILE_NAME, false, false, null)]
        [DataRow(TestHelpers.Constants.IPI_DATA_FILE_NAME, true, true, null)]
        [DataRow(TestHelpers.Constants.IPI_DATA_FILE_NAME, false, true, null)]
        [DataRow(TestHelpers.Constants.IPI_DATA_FILE_NAME, true, false, "key1")]
        [DataRow(TestHelpers.Constants.IPI_DATA_FILE_NAME, true, true, "key1")]
        public void IpiPipelineBuilder_CheckConfiguration(
            string datafilename, bool autoUpdate, bool shareUsage, string licenseKey)
        {
            ...
            // Get the IP intelligence engine element and check that it has
