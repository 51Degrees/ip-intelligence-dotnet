...
namespace FiftyOne.IpIntelligence.Engine.OnPremise.Data
{
    ...
    /// <see cref="IFiftyOneAspectPropertyMetaData"/> interface
    ...
    public class PropertyMetaDataIpi : IFiftyOneAspectPropertyMetaData, IDisposable
    {
        private readonly PropertyMetaDataSwig _source;
        private readonly IpiOnPremiseEngine _engine;

        internal PropertyMetaDataIpi(IpiOnPremiseEngine engine, PropertyMetaDataSwig source)
        {
            _source = source;
            _engine = engine;
