...
internal class ResultsIpiSwig : ResultsBaseSwig {
  ...
  public CoordinateValueSwig getValueAsCoordinate(int requiredPropertyIndex) {
    CoordinateValueSwig ret = new CoordinateValueSwig(IpIntelligenceEngineModulePINVOKE.ResultsIpiSwig_getValueAsCoordinate__SWIG_1(swigCPtr, requiredPropertyIndex), true);
    if (IpIntelligenceEngineModulePINVOKE.SWIGPendingException.Pending) throw IpIntelligenceEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
