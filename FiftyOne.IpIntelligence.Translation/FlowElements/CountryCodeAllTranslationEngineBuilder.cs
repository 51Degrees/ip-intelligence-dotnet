...
{
    /// <summary>
    /// Builder for the <see cref="CountryCodeAllTranslationEngine"/> element.
    /// This requires no configuration, as all the configuration for the base
    /// translation engine is taken care of.
    /// </summary>
    public class CountryCodeAllTranslationEngineBuilder
    {
        ...
        /// </param>
        public CountryCodeAllTranslationEngineBuilder(ILoggerFactory loggerFactory)
        {
            _loggerFactory = loggerFactory;
        }

        /// <summary>
        /// Build a new instance of <see cref="CountryCodeAllTranslationEngine"/>.
        /// </summary>
        /// <returns></returns>
        public CountryCodeAllTranslationEngine Build()
        {
            return new CountryCodeAllTranslationEngine(
                _loggerFactory.CreateLogger<CountryCodeAllTranslationEngine>(),
                CreateData);
        }
